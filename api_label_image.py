...
if __name__ == "__main__":
  ...
  link="http://"+ip_mojordomo+"/objects/?op=set&object=" +name_of_object+ '&p='+property_of_object_1+'&v=' + zerg_tipe
  f=urllib.request.urlopen(link)
  link="http://"+ip_mojordomo+"/objects/?op=set&object=" +name_of_object+ '&p='+property_of_object_2+'&v=' + zerg_probability
  f=urllib.request.urlopen(link)
